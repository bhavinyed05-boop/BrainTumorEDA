...
def plot_vertical_dashboard(df_meta, categories):
    ...
    ax_title1.set_title("SECTION 1: MRI Sample Images (Random Samples)",
    ...
    ax_intensity.set_title("SECTION 2: Voxel Intensity Distribution",
                           fontsize=15, fontweight='bold', pad=15, color='#2c3e50', loc='left')
    ...
    ax_spatial.set_title("SECTION 3: Image Size and Dimension Analysis",
                         fontsize=15, fontweight='bold', pad=15, color='#2c3e50', loc='left')
    ...
    ax_bar.set_title("SECTION 4: Dataset Class Distribution",
                     fontsize=15, fontweight='bold', pad=15, color='#2c3e50', loc='left')
    ...
    fig.suptitle("BRAIN TUMOR MRI Exploratory Data Analysis", fontsize=22, fontweight='bold', x=0.5)

    # Save to your local folder base BEFORE calling plt.show() so canvas constraints hold true
    plt.savefig('Brain EDA.png', dpi=300, bbox_inches='tight')
    print("Dashboard image rendered successfully and saved to: Brain EDA.png")
    plt.show()